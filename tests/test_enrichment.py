"""
Automated Pytest for telehealth-encounter-documentation-agent Enrichment Modules.
"""
import sys
...
from enrichment import (
    ...
    TelehealthencounterdocumentationagentEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = TelehealthencounterdocumentationagentEnrichmentSuite()
