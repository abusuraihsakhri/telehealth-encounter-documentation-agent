...
import pytest
from telehealth_audit.models import FrontierPayload, ExecutionStatus
from telehealth_audit.engine import FrontierDomainEngine
from telehealth_audit.agents import AudioVideoModalityAgent, InterstateLicensureVerifierAgent, CMSBillingModifierAgent, TeleHealthAuditCoordinator
from telehealth_audit.cli import main


def test_sub_agents():
    a1 = AudioVideoModalityAgent()
    ...
    a2 = InterstateLicensureVerifierAgent()
...
def test_coordinator():
    coord = TeleHealthAuditCoordinator()
    ...
    assert "CMS Telehealth Services Guidelines 2024" in ans or "specifications" in ans
